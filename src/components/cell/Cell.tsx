...
const cellColors = ["empty", "red", "green", "blue", "yellow", "orange", "brown", "white", "black"];

const Cell = ({ colorId, isActive, onClick }: ICellProps) => {
	const isColorNumeration = useSelector((state: RootState) => state.settings.isColorNumeration);
